...
if __name__ == '__main__':
    ...
    write_latex_tabular(refined_results['cubic'], 'threesum_cubic_table.tex')
    write_latex_tabular(refined_results['quadratic'], 'threesum_quadratic_table.tex')
    write_latex_tabular(refined_results['hashmap'], 'threesum_hashmap_table.tex')
    plot_algorithms(refined_results, 'threesum_data_plot.pdf')
